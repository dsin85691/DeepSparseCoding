...
class BaseModel(object):
    ...
    def write_checkpoint(self):
        ...
        #     print(key)
        #     print(key[0:2])
        #     if key[0:12] in ['main_module']:
        #         new_dictionary[key[12:]] = self.state_dict()[key]
        # print("THIS IS THE NEW DICTIONARY:", new_dictionary)
        torch.save(self.state_dict(), self.params.cp_latest_filename)
        self.log_info('Full model saved in file %s'%"transposed_model.pt")
